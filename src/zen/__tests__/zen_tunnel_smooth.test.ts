...
describe('Zen tunnel — path-relative membership: in iff TRUE perpendicular distance ≤ halfWidth', () => {
  // The PURE Frenet tube boundary (#153): "just outside hw → terrain". The tunnel is the proven
  // warp-segregated tube (the drive-down basin/seam was reverted) — leaving the tube sideways is always
  // terrain, so this boundary holds outright again.
